...
# Initialize body and hand estimation models
# body_estimation = Body('/workspace/projects/HieraFashDiff/model/body_pose_model.pth')
# hand_estimation = Hand('/workspace/projects/HieraFashDiff/model/hand_pose_model.pth')

class OpenposeDetector:
    def __init__(self,
                 body_model_path="/workspace/projects/HieraFashDiff/model/body_pose_model.pth",
                 hand_model_path="/workspace/projects/HieraFashDiff/model/hand_pose_model.pth"):
